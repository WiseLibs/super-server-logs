...
describe('WorkerLogger', function () {
	...
	describe('logging methods', function () {
		specify('WORKER_STARTED() logs and flushes an event');
		specify('WORKER_GOING_ONLINE() logs and flushes an event');
		specify('WORKER_ONLINE() logs and flushes an event');
		specify('WORKER_GOING_OFFLINE() logs and flushes an event');
		specify('WORKER_OFFLINE() logs and flushes an event');
		specify('WORKER_DONE() logs and flushes an event');
	...
	describe('newRequest()', function () {
		it('returns a new RequestLogger');
	});
	...
	describe('constructor', function () {
		...
		describe('options.workerId', function () {
			it('sets the workerId integer to include in all logs');
			it('throws if not a positive integer');
		});
	});
